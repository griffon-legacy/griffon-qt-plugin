griffon.project.dependency.resolution = {
    ...
    repositories {
        ...
        flatDir name: "qtLibDir", dirs: ["${basePath}lib"]
    }
    dependencies {
        String qtVersion = '4.6.3'
        build "com.trolltech:qtjambi:$qtVersion",
              "com.trolltech:qtjambi-util:$qtVersion"
        compile "com.trolltech:qtjambi:$qtVersion",
                "com.trolltech:qtjambi-util:$qtVersion"
    }
}
