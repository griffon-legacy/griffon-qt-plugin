 ...
 */
class QPixmapFactory extends QObjectFactory {
    QPixmapFactory() {
        super(QPixmap)
    }
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        if (value == null) {
            if (attributes.containsKey("pixmap")) {
        ...
        if (value == null) {
            throw new RuntimeException("$name has neither a value argument or one of pixmap: or pixmap:")
        }
